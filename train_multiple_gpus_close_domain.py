...
def ansyc_multiple_process_train(args, save_dir):
    ...
    data_lists = [build_datasets(metann_params['search_space']) for _ in range(args.gpus)]
...
if __name__ == "__main__":
    ...
    parser.add_argument('--search_budget', type=int, default=150,
    ...
    parser.add_argument('--search_space', type=str, default='nasbench_case2',
                        choices=['nasbench_case1', 'nasbench_case2', 'nasbench_201'], help='nasbench')
    parser.add_argument('--algo_params', type=str, default='nasbench101_case2',
    ...
    parser.add_argument('--save_dir', type=str,
                        default='/home/albert_wei/Disk_A/train_output_npenas/npenas_case2/',
