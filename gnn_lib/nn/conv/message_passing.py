...
class MessagePassing(torch.nn.Module):
    ...
    We generally refer to x_i as the nodes which aggregate information,
    and to x_j as the nodes which send information along the edges.
    The default message passing flow is source_to_target, so x_i refers to the targets and
    x_j refers to the source nodes. If you want to change this behavior, you can change the
    message passing flow via flow="target_to_source".
